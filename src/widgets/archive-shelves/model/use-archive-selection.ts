...
import { MAX_ARCHIVE_SELECTION, MAX_ARCHIVE_SHARE_FILES } from "@/shared/config";
...
const CAP_TOAST_ID = "archive-selection-cap";
...
export type ArchiveSelectionOptions = {
  /**
