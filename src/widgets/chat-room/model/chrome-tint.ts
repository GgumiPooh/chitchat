...
// WARN: DESIGN.md § 7.16. The same 70% `ChatBackdrop` draws its wash at, and the two MUST move together — what borders the chrome is the photo *under* that wash, so the bare average publishes a colour visibly deeper than the room beside it.
const WASH_AMOUNT = "70%";
