...
// INFO: REQUIREMENTS.md § 8.14. `⌥1`/`⌥2`/`⌥3` are the room's, because whether the panel is on screen at all is its state — so the room needs the bar's own order to read the digits by.
