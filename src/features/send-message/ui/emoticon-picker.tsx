              ...
              <div className="grid grid-cols-4 gap-2xs">
                {shown.map((item) => (
                  <span key={item.id} className="group relative flex">
                    ...
                    {/* WARN: `keepsScroll` is what makes the overlay survivable on a tiled cell — without it the switch tracks the drag itself and the panel stops scrolling (`DESIGN.md § 7.15.`). */}
