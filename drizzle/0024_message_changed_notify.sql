...
-- INFO: REQUIREMENTS.md § 8.13. One channel for both mutations — the stream reads the row back, and `getMessage` answering NULL is what "deleted" means on the wire, so no discriminator rides the payload.
