...
ARG NEXT_PUBLIC_KEYWORD_SUGGESTION_CONCURRENCY
ARG NEXT_PUBLIC_KEYWORD_SUGGESTION_BATCH
ARG NEXT_PUBLIC_SHORTCUT_ICLOUD_URL
ARG NEXT_PUBLIC_UPLOAD_OPTIMIZATION
...
ENV NEXT_PUBLIC_KEYWORD_SUGGESTION_CONCURRENCY=$NEXT_PUBLIC_KEYWORD_SUGGESTION_CONCURRENCY
ENV NEXT_PUBLIC_KEYWORD_SUGGESTION_BATCH=$NEXT_PUBLIC_KEYWORD_SUGGESTION_BATCH
ENV NEXT_PUBLIC_SHORTCUT_ICLOUD_URL=$NEXT_PUBLIC_SHORTCUT_ICLOUD_URL
ENV NEXT_PUBLIC_UPLOAD_OPTIMIZATION=$NEXT_PUBLIC_UPLOAD_OPTIMIZATION
