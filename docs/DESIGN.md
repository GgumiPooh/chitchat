...
| Outside the shell | `canvas`, same as the shell. A 1px `hairline` down each side is what separates the column on desktop                                                               |
