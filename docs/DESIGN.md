...
| Rule        | Value                                                                                                                                                                                                                                                                                 |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Tab bar     | A pill inset from the viewport's bottom edge by `--bar-lift` — `--bar-float-gap` (4) plus `env(safe-area-inset-bottom)`, the safe-area term dropped while the keyboard covers it (§ 3.4.) — and by `md` each side                                                                     |
