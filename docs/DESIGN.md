...
| Full-bleed photos   | `lvh`, never a synced property — `50lvh` where the box _is_ the background, `100lvh` top-anchored and clipped where it sits behind a screen (§ 7.16.)                                       |
