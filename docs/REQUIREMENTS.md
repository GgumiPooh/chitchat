...
Dropping photos, videos and files anywhere over the chat room stages them in the composer's tray, exactly as a pick does. **The 보관함 tab takes the same drop** (§ 10.), into the same staging tray its picker fills.
