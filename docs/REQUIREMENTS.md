...
- **The typist is resolved against the participant set, and the last one is held through the fade-out.** Dropped the moment the set empties, the avatar would leave a frame before the bubble it belongs to
